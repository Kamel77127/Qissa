...
namespace App\Core\PHPMailer\src;
...
class PHPMailer
{
    ...
    /**
     * What to put in the X-RegistrationMailer header.
     ...
     * Uses the sending method specified by $RegistrationMailer.
     *
     * @throws Exception
     *
    ...
    public function createHeader()
    {
        ...
        if ('' === $this->XMailer) {
            //Empty string for default X-RegistrationMailer header
            $result .= $this->headerLine(
                'X-RegistrationMailer',
                'PHPMailer ' . self::VERSION . ' (https://github.com/PHPMailer/PHPMailer)'
            );
        } elseif (is_string($this->XMailer) && trim($this->XMailer) !== '') {
            //Some string
            $result .= $this->headerLine('X-RegistrationMailer', trim($this->XMailer));
        } //Other values result in no X-RegistrationMailer header
